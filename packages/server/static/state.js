...
export const els = {
  ...
  currentActionSummaryEl: document.getElementById("current-action-summary"),
  resumeSummaryEl: document.getElementById("resume-summary"),
  resumeCheckpointSelectEl: document.getElementById("resume-checkpoint-select"),
  resumeTargetPhaseSelectEl: document.getElementById("resume-target-phase-select"),
  resumeValidationPreviewEl: document.getElementById("resume-validation-preview"),
  resumeBlockedExplanationEl: document.getElementById("resume-blocked-explanation"),
  resumeRunBtn: document.getElementById("resume-run-btn"),
  replayNavSummaryEl: document.getElementById("replay-nav-summary"),
  runReplayViewerEl: document.getElementById("run-replay-viewer"),
  runAuditTrailEl: document.getElementById("run-audit-trail"),
  ...
  policySummaryEl: document.getElementById("policy-summary"),
